  ...
  return (
    <div className="my-10">
      ...
      <p className="text-black lg:text-xl text-xs">
        ...
        user-friendly web interfaces. My expertise spans HTML, CSS, JavaScript,
        React.js, Node.js, Express.js, Firebase, MongoDB, and Tailwind CSS. With
        a strong focus on design and an ongoing commitment to enhancing my
        skills, I strive to deliver seamless and engaging user experiences.
        I have been involved in web development for several days. I am still learning. I have also done several projects. Still doing the project. My dream is to become a MERN stack developer. Inshallah that dream will be fulfilled very soon. My web development journey started in 2023. My journey continues with <a className="text-purple-600 hover:link"target="_blank" href="https://web.programming-hero.com/">programming hero</a> in hand. Then in the long run dedication and hard work made me a junior web developer.
      </p>
      <p className="py-4">
      ...
      <div>
        ...
        <div class="flex justify-center items-center py-5 my-10">
          <Link 
            to={"/skills"}
