  ...
  return (
    <div className="my-10">
      ...
      <p className="text-black lg:text-xl text-xs">
        ...
        skills, I strive to deliver seamless and engaging user experiences. I
        have been involved in web development for several days. I am still
        learning. I have also done several projects. Still doing the project. My
        dream is to become a MERN stack developer. Inshallah that dream will be
        fulfilled very soon. My web development journey started in 2023. My
        ...
        in hand. Then in the long run dedication and hard work made me a junior
        web developer.
      </p>
      <p className="py-4">
